class Snow{
     constructor(x,y)
     { var options = { friction: 0.001, restitution:0.1, isStatic:false } 
     this.snow = Bodies.circle(x,y,5,options) 
     this.radius = 5;
      var rand=Math.round(random(1,2))
     var img; if(rand===1){ img="snow4.webp"; } else{ img="snow5.webp"; } 
     this.image=loadImage(img); World.add(world, this.snow);
}
updateY(){ 
